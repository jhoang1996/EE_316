...
HD_PWD='C:/Users/Justin/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatchController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatchController.tcl
