...
HD_PWD='C:/Users/Justin/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatchController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatchController.tcl -notrace
