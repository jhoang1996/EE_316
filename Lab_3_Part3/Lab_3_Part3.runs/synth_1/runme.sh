...
HD_PWD='C:/Users/Justin/Lab_3_Part3/Lab_3_Part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_Display.tcl
